...
fn numpy_data_pointer_i8(numpy_array: PythonObject) raises -> DTypePointer[DType.int8]:
...
fn numpy_data_pointer_i16(numpy_array: PythonObject) raises -> DTypePointer[DType.int16]:
...
fn numpy_data_pointer_i32(numpy_array: PythonObject) raises -> DTypePointer[DType.int32]:
...
fn numpy_data_pointer_i64(numpy_array: PythonObject) raises -> DTypePointer[DType.int64]:
...
fn numpy_data_pointer_ui8(numpy_array: PythonObject) raises -> DTypePointer[DType.uint8]:
...
fn numpy_data_pointer_ui16(numpy_array: PythonObject) raises -> DTypePointer[DType.uint16]:
...
fn numpy_data_pointer_ui32(numpy_array: PythonObject) raises -> DTypePointer[DType.uint32]:
...
fn numpy_data_pointer_ui64(numpy_array: PythonObject) raises -> DTypePointer[DType.uint64]:
...
fn numpy_data_pointer_f16(numpy_array: PythonObject) raises -> DTypePointer[DType.float16]:
...
fn numpy_data_pointer_f32(numpy_array: PythonObject) raises -> DTypePointer[DType.float32]:
...
fn numpy_data_pointer_f64(numpy_array: PythonObject) raises -> DTypePointer[DType.float64]:
...
fn numpy_data_pointer_bf16(numpy_array: PythonObject) raises -> DTypePointer[DType.bfloat16]:
...
fn numpy_data_pointer_tf32(numpy_array: PythonObject) raises -> DTypePointer[DType.tensor_float32]:
