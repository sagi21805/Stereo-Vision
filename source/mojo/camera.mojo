...
struct Camera:
    ...
    fn __init__[frame_size: Size[DType.uint16], fov: FOV[DType.float32]](inout self) raises:
        Python.add_to_path("../python")
        var python_utils: PythonObject = Python.import_module("_utils")
    ...
    fn angle_to_camera(inout self, position: Pose2d[DType.float32]) -> FOV[DType.float32]:
