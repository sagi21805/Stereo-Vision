...
module_name = "custom_algs"

src_dir = "source/algorithms/src"  # Directory where your source files are located
...
ext_modules = [
    Pybind11Extension(
        f"{module_name}",
        sources + ["source/bindings.cpp"],
        
        include_dirs=["source/algorithms/include"],
